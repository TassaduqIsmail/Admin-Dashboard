(function ($) {
    ...
    if ($("#currency_table").length > 0) {
        $.get(
            "https://hamariweb.com/finance/forex/open_market_rates.aspx",
            function (data) {
        ...
        if (this.checked) {
            ...
            if (
                document
                    ...
                    .classList.contains("login-img") !== true
            ) {
                document
...
$(".layout-setting").on("click", function (e) {
    if (!document.querySelector("body").classList.contains("dark-mode")) {
        ...
        $(".header-logo").attr(
            "src",
            $(".header-logo").attr("data-black-logo")
        );
    } else {
        $("body").removeClass("dark-mode");
        $("body").addClass("light-mode");
        ...
        $(".header-logo").attr(
            "src",
            $(".header-logo").attr("data-white-logo")
        );
    }
});
...
function resetData() {
    ...
    document
        .getElementById("style")
        ?.setAttribute("href", "../assets/plugins/bootstrap/css/bootstrap.css");
    var carousel = $(".owl-carousel");
    if (carousel) {
        $.each(carousel, function (index, element) {
            // element == this
...
document.addEventListener("DOMContentLoaded", function () {
    jQuery(".category-slider li:first").addClass("active");

    // quick search regex
    var qsRegex;
    var buttonFilter = jQuery(".category-slider li:first").attr("data-filter");
    ...
    jQuery(".category-slider").on("click", "li", function () {
        jQuery(".category-slider li").removeClass("active"),
